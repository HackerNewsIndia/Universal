...
function Register({ onRegister, setUser: setGlobalUser }) {
  ...
  <h2 className="mt-10 text-center text-2xl font-bold leading-9 tracking-tight text-blue-900">
    Welcome To Universal
        ...
        {/* ... other form fields ... */}
        <span class="block mb-1 text-md font-medium text-gray-700">User Name</span>
        <input
...
<span class="block mb-1 text-md font-medium text-gray-700">Your Email</span>
        <input
          className=" appearance-none border rounded w-full py-2 px-3 mb-4 leading-tight focus:outline-none shadow-sm"
          type="email"
          name="email"
...
<span class="block mb-1 text-md font-medium text-gray-700">Create a password</span>
        <input
          className=" appearance-none border rounded w-full py-2 px-3 mb-4 leading-tight focus:outline-none shadow-sm"
          type="password"
          name="password"
